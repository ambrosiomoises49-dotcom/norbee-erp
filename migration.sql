...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('priority', 'CALENDAR', 'AI', 'STOCK_LOW', 'PAYMENT_DUE', 'SALE_COMPLETED', 'TRANSFER_RECEIVED', 'SALARY_DUE', 'SYSTEM', 'OTHER', 'EVENT_REMINDER');
...
CREATE TABLE "CostCategory" (
    ...
    "periodicity" "CostPeriodicity" NOT NULL DEFAULT 'NONE',
...
CREATE TABLE "Cost" (
    ...
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "paymentStatus" "CostPaymentStatus" NOT NULL DEFAULT 'PENDING',
    "paidAt" TIMESTAMP(3),
...
CREATE TABLE "Event" (
    ...
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "color" TEXT NOT NULL DEFAULT '#f9bbbb',
